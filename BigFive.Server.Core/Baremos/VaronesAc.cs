...
{
    public class VaronesAc : IBaremo
    {
            ...
            return new List<Valor>
                       {
                           ...
                           ,new Valor{Percentil = 2  , PuntuacionDirectaHasta = 26, PuntuacionT = 29}
                           ...
                           ,new Valor{Percentil = 5  , PuntuacionDirectaHasta = 31, PuntuacionT = 34}
                           ,new Valor{Percentil = 10, PuntuacionDirectaHasta = 33, PuntuacionT = 37}
                           ...
                           ,new Valor{Percentil = 96, PuntuacionDirectaHasta = 53, PuntuacionT = 68}
