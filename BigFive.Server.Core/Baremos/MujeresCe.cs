...
{
    public class MujeresCe : IBaremo
    {
            ...
            return new List<Valor>
                       {
                           ...
                           ,new Valor{Percentil = 15, PuntuacionDirectaHasta = 25, PuntuacionT = 40}
                           ,new Valor{Percentil = 20, PuntuacionDirectaHasta = 37, PuntuacionT = 42}
                           ,new Valor{Percentil = 25, PuntuacionDirectaHasta = 28, PuntuacionT = 43}
                           
                           ,new Valor{Percentil = 30, PuntuacionDirectaHasta = 29, PuntuacionT = 44}
                           ,new Valor{Percentil = 35, PuntuacionDirectaHasta = 30, PuntuacionT = 46}
                           ...
                           ,new Valor{Percentil = 55, PuntuacionDirectaHasta = 34,  PuntuacionT = 51}
                           ...
                           ,new Valor{Percentil = 98, PuntuacionDirectaHasta = 47, PuntuacionT = 71}
