...
{
    public class VaronesDi : IBaremo
    {
            ...
            return new List<Valor>
                       {
                           ...
                           ,new Valor{Percentil = 4  , PuntuacionDirectaHasta = 28, PuntuacionT = 32}
                           ...
                           ,new Valor{Percentil = 55, PuntuacionDirectaHasta = 40, PuntuacionT = 51}
                           ,new Valor{Percentil = 60, PuntuacionDirectaHasta = 41, PuntuacionT = 53}
                           ,new Valor{Percentil = 65, PuntuacionDirectaHasta = 42, PuntuacionT = 54}
                           ,new Valor{Percentil = 70, PuntuacionDirectaHasta = 43, PuntuacionT = 56}
                           ...
                           ,new Valor{Percentil = 85, PuntuacionDirectaHasta = 46, PuntuacionT = 60}
