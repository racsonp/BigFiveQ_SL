...
{
    public class VaronesPe : IBaremo
    {
            ...
            return new List<Valor>
                       {
                           ...
                           ,new Valor{Percentil = 2  , PuntuacionDirectaHasta = 28, PuntuacionT = 29}
                           ...
                           ,new Valor{Percentil = 30, PuntuacionDirectaHasta = 38, PuntuacionT = 44}
                           ,new Valor{Percentil = 35, PuntuacionDirectaHasta = 39, PuntuacionT = 46}
                           ...
                           ,new Valor{Percentil = 55, PuntuacionDirectaHasta = 42, PuntuacionT = 51}
                           ...
                           ,new Valor{Percentil = 75, PuntuacionDirectaHasta = 45, PuntuacionT = 57}

                           ,new Valor{Percentil = 80, PuntuacionDirectaHasta = 46, PuntuacionT = 58}
                           ...
                           ,new Valor{Percentil = 97, PuntuacionDirectaHasta = 54, PuntuacionT = 69}
                           ,new Valor{Percentil = 98, PuntuacionDirectaHasta = 55, PuntuacionT = 71}
