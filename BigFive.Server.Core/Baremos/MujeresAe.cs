...
{
    public class MujeresAe : IBaremo
    {
            ...
            return new List<Valor>
                       {
                           ...
                           ,new Valor{Percentil = 1  , PuntuacionDirectaHasta = 28, PuntuacionT = 27}
                           ,new Valor{Percentil = 2  , PuntuacionDirectaHasta = 30, PuntuacionT = 29}
                           ,new Valor{Percentil = 3  , PuntuacionDirectaHasta = 31, PuntuacionT = 31}
                           ,new Valor{Percentil = 4  , PuntuacionDirectaHasta = 32, PuntuacionT = 32}
                           ,new Valor{Percentil = 5  , PuntuacionDirectaHasta = 34, PuntuacionT = 34}
                           ...
                           ,new Valor{Percentil = 60, PuntuacionDirectaHasta =   0, PuntuacionT = 53}
