...
{
    public class AperturaCultura: ISubDimension
    {
        public string Name { get { return "Apertura a la Cultura"; } }
        public string Symbol { get { return "Ac"; } }
        ...
        private readonly IPlantillaCorreccion _plantillaCorreccion = new AperturaCulturaPlantilla();
