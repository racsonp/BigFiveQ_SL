...
{
    public class ControlImpulsos     : ISubDimension
    {       
        public string Name { get { return "Control de Impulsos"; } }
        public string Symbol { get { return  "Ci"; } }
     ...
     set { }
        ...
        private readonly IPlantillaCorreccion _plantillaCorreccion = new ControlImpulsosPlantilla();
