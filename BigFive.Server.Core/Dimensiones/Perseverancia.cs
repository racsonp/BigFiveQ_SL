...
{
    public class Perseverancia : ISubDimension
    {
        public string Name { get { return "Perseverancia"; } }
        public string Symbol { get { return "Pe"; } }
        ...
        private readonly IPlantillaCorreccion _plantillaCorreccion = new PerseveranciaPlantilla();
