...
{
    public class Cooperacion : ISubDimension
    {
        public string Name { get { return "Cooperacion"; } }
        public string Symbol { get { return "Cp"; } }
        ...
        private readonly IPlantillaCorreccion _plantillaCorreccion = new CooperacionPlantilla();
